<template>
  <v-dialog v-model="dialog" width="500">
    <v-card>
      ...
      <v-card-text v-html="message || 'Are you sure you want to delete this item ?'"/>
...
export type WidgetConfirmDeleteDialogRef = InstanceType<typeof WidgetConfirmDeleteDialog>;
</script>
